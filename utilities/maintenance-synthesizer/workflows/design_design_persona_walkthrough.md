# Workflow: Persona Walkthrough Specialist SOP
...
## Step 2: Phase 0 — Pre-Arrival (no screenshot)
...
## Step 3: Phase 1 — Five-Second Test (above-the-fold screenshot)
...
## Step 4: Phase 2 — Progressive Scroll (one entry per fold)
